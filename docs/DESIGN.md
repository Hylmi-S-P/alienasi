...
- **Komponen**:
  ...
  4. *Tombol Aksi Utama Ekspor*:
     - Tombol 1 (Primer): `Bagikan Laporan PDF ke WhatsApp Ibu` (Membuka dialog kirim dokumen langsung).
     - Tombol 2 (Sekunder): `Pratinjau Dokumen PDF` (Melihat tampilan lembar cetak sebelum dikirim).
